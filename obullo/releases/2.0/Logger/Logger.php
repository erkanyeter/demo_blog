...
Class Logger
{
    ...
    */
    public function __construct()
    {
        ...
        $handler = $config['log_handler'][$this->handler];

        $this->driver = new $handler($this);
    }
    ...
    public function push($handler = 'email')
    {
        ...
        $handlerClass = $this->push_handlers[$handler];

        if ( ! isset($this->push_data[$handler])) {
            $this->push_data[$handler] = new $handlerClass;
        }
...
/* Location: .Obullo/Logger/Logger.php */