...
Class Auth
{
    ...
    public $regenerate_sess_id = false;   // Set to true to regenerate the session id on every page load 
                                          // or leave as false to regenerate only upon new login.
    ...
    public function __construct()
    {
        ...
        foreach ($c['config']->load('auth') as $key => $val) {
            $this->{$key} = $val;
        }
