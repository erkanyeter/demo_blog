...
Class Redis implements DriverInterface
{
    ...
    public function __construct($params = array())
    {
        ...
        if ( ! isset($this->params['servers']['hostname']) OR ! isset($this->params['servers']['port'])) {
            throw new RunTimeException(
                sprintf(
        ...
        $serializer = ( ! isset($this->params['serializer'])) ? SERIALIZER_PHP : $this->params['serializer'];
    ...
    public function connect()
    {
        ...
        $expiration  = (isset($this->params['servers']['timeout'])) ? $this->params['servers']['timeout'] : 0;

        $this->redis->connect($this->params['servers']['hostname'], $this->params['servers']['port'], $expiration);
...
/* Location: .Obullo/Cache/Redis.php */