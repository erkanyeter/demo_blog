...
Class Sess_Native {
    ...
    */
    function _read()
    {
        ...
        if ($this->match_ip == true AND isset($_SESSION['ip_address']) 
            AND $session['ip_address'] != $_SESSION['ip_address'])
        {
            $this->destroy();
        ...
        if ($this->match_useragent == true AND isset($_SESSION['user_agent']) 
            AND $session['user_agent'] != $_SESSION['user_agent'])
        {
            $this->destroy();
