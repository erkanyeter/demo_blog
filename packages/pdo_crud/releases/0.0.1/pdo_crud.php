...
Class Pdo_Crud {
    ...
    */
    ...
    public function __call($method, $arguments)
    {
        ...
        if ( ! function_exists('Pdo_Crud\\Src\\'.$method)) {
            include PACKAGES .'pdo_crud'. DS .'releases'. DS .$packages['dependencies']['pdo_crud']['version']. DS .'src'. DS .strtolower($method). EXT;
        }

        return call_user_func_array('Pdo_Crud\\Src\\'.$method, $arguments);
    }
