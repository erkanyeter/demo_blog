...
function submitAjax(formId){
    ...
    <body>
        ...
        <section>
            <?php echo $this->form->open('tutorials/hello_form_model_ajax/index', array('method' => 'POST', 'id' => 'odm_tutorial')) ?>
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td><?php echo $this->form->password('user_password', '', " id='user_password' ") ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo $this->form->label('Confirm') ?></td>
                        <td><?php echo $this->form->password('confirm_password', '', " id='confirm' ") ?>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                    ...
                    <tr>
                        <td></td>
                        <td><?php echo $this->form->submit('dopost', 'Do Post', ' onclick="submitAjax(\'odm_tutorial\')" ') ?></td>
                    </tr>
                    <tr>
                        <td colspan="2">&nbsp;</td>
                    </tr>
