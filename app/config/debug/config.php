...
$config = array(
	...
	'index_page'     => '', // Typically this will be your index.php file, If mod_rewrite enabled remove the page set this variable so that it is blank.
	'url_suffix'     => '', // Allows you to add a suffix to all URLs generated by Framework.

	// Determines allowed uri extensions, e.g. : http://example.com/web_service/example.json
	'allowed_extensions' => array('.array','.html','.json','.xml','.rss'), 	// $this->uri->getExtension() method grab the current extension.
