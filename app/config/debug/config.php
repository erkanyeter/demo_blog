...
$config = array(
	...
	'log_driver'	  => null,// new Log_Writer_File,
	...
	'cookie_time'   => strtotime(' +2 months '), 	// Cookie expire time.
	...
	'csrf_expire'      => strtotime(' +1 hour ' ),  // The number in seconds the token should expire.
