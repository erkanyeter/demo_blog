...
$sess = array(
	...
	'expiration' => 7200,			// The number of SECONDS you want the session to last. By default sessions last 7200 seconds (two hours)."0" no expiration.
	...
	'get' => new Get,				// Set Get object
	'request' => new Request,		// Set Request object
	'database' => null,				// null, // new Db, new Cache; // new Mongo_Db;   Set database object
